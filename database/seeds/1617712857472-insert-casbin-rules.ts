  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    const frontendRoutes: CasbinValue = {
      '/admin/perfil': {
        ...
        [RolEnum.SOPORTE]: 'read|update',
        [RolEnum.INVITADO]: 'read|update',
      },
      ...
      '/admin/usuarios': {
        ...
        [RolEnum.SOPORTE]: 'read|update',
        [RolEnum.INVITADO]: 'read',
      },
      '/admin/roles': { [RolEnum.ADMINISTRADOR]: 'read|create|update|delete' },
      '/admin/parametros': {
      ...
      '/admin/modulos': { [RolEnum.ADMINISTRADOR]: 'read|update|create' },
    ...
    const backendRoutes: CasbinValue = {
      ...
      '/api/parametros/row/:grupo/listado': {
        [RolEnum.ADMINISTRADOR]: 'GET|POST',
      },
      ...
      '/api/parametros/imagen/:id': { [RolEnum.ADMINISTRADOR]: 'GET' },

      '/api/autorizacion/permisos': { [RolEnum.TODOS]: 'GET' },

      '/api/usuarios/cuenta/perfil': { [RolEnum.TODOS]: 'GET' },
